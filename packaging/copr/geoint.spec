...
Source0:        https://github.com/opengeos/GeoLibre/releases/download/v%{version}/GeoInt.Desktop-%{version}-1.x86_64.rpm
...
- Automated release of GeoInt 1.5.0 (repackaged from the upstream RPM).
