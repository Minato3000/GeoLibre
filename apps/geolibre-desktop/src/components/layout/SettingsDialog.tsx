...
import { closeRightPanel, collapseRightPanel, openRightPanel } from "@geoint/plugins";
import {
  Button,
  Dialog,
  DialogContent,
...
export const OPEN_SETTINGS_EVENT = "geoint:open-settings";
...
export function SettingsDialog({
  ...
  // Let other panels deep-link into a specific Settings section.
  useEffect(() => {
      ...
      <DropdownMenu>
        ...
        <DropdownMenuContent align="start" className="w-56">
          ...
          <DropdownMenuSub>
            ...
            <DropdownMenuSubContent className="geoint-layout-submenu w-40 sm:w-72">
              <DropdownMenuCheckboxItem
