#!/usr/bin/env bash
#
# Render the PKGBUILD for the `geoint-bin` AUR package.
#
...
# Usage:
#   VERSION=1.5.0 \
#   SHA256_AMD64=<sha256 of GeoInt.Desktop_<version>_amd64.deb> \
...
conflicts=('geoint')
options=('!strip' '!debug')
source=("\${pkgname}-\${pkgver}.deb::https://github.com/${REPO}/releases/download/v\${pkgver}/GeoInt.Desktop_\${pkgver}_amd64.deb")
