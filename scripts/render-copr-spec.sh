#!/usr/bin/env bash
#
# Render the RPM .spec for the Fedora COPR `geoint` package.
#
...
#
# Usage:
#   VERSION=1.5.0 DATE=2026-06-20 scripts/render-copr-spec.sh > geoint.spec
#
...
%global appid org.geoint.desktop
...
Source0:        https://github.com/${REPO}/releases/download/v%{version}/GeoInt.Desktop-%{version}-1.x86_64.rpm
...
- Automated release of GeoInt ${VERSION} (repackaged from the upstream RPM).
SPEC
