#!/usr/bin/env bash
#
# Render the AppStream metainfo for the GeoInt desktop app.
#
...
#
# Usage:
#   VERSION=1.5.0 DATE=2026-06-20 scripts/render-linux-metainfo.sh > org.geoint.desktop.metainfo.xml
#
...
<component type="desktop-application">
  <id>org.geoint.desktop</id>
  <metadata_license>CC0-1.0</metadata_license>
  <project_license>MIT</project_license>
  <name>GeoInt Desktop</name>
  <summary>Lightweight, cloud-native GIS platform</summary>

  <description>
    <p>
      GeoInt is a lightweight, cloud-native desktop GIS for visualizing and
    ...
    <p>
      ...
      Spatial. Projects are saved in an open .geoint.json format, and the app
  ...
  <launchable type="desktop-id">org.geoint.desktop.desktop</launchable>
  ...
  <screenshots>
    <screenshot type="default">
      <image>https://files.opengeos.org/GeoInt-demo.webp</image>
      <caption>3D Tiles rendered on a MapLibre map in GeoInt</caption>
    </screenshot>
  </screenshots>
