...
![Add Vector Layer panel with the sample URL ready to load](https://data.geolibre.app/images/geoint-add-vector-panel.webp)
...
- In the desktop app, use **Project → Save** to write a `.geoint.json` file.
