...
GeoInt ("the app") is a free, open-source GIS application
developed by the OpenGeos community. By downloading, installing, or using
GeoInt — including its desktop, web, and embedded builds — you agree to these
Terms of Service ("Terms"). If you do not agree, do not use the app.

## The service

GeoInt lets you view, create, analyze, and share geospatial data. It runs
...
GeoInt is open-source software distributed under the MIT License, as published
...
You agree to use GeoInt lawfully and responsibly. In particular, you agree not
to:
...
Optional GeoInt features let you authenticate with and access third-party
...
- GeoInt uses Google OAuth solely to obtain, on your behalf and with your
  consent, the access token needed to make Earth Engine requests you initiate.
  GeoInt does not sell your data, and does not use Google user data for
...
GeoInt does not control these third-party services and is not responsible for
their availability, content, or conduct.

## Your content

GeoInt does not claim ownership of the data, files, or projects you open or
...
GeoInt is provided **"as is" and "as available", without warranties of any
...
GeoInt, even if advised of the possibility of such damages.

## Changes to the app and these Terms

GeoInt is under active development, and features may be added, changed, or
